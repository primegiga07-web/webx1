...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-shard-secret-key-6a5b4c3d')
...
WSGI_APPLICATION = 'shard.wsgi.application'
...
SHARD_PREFIX = os.getenv('SHARD_PREFIX', 'RW100')
...
# Django Email Configurations (SMTP)
EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.gmail.com')
EMAIL_PORT = int(os.getenv('EMAIL_PORT', '587'))
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'True') == 'True'
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'WebX Support <noreply@webx.app>')
